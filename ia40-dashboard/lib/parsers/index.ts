...
export const CATEGORY_PARSERS: Record<string, CategoryParser> = {
  ...
  // importador como Marca, ver paso 2 de sillasDeRuedas.ts). Antes esta
  // funcion cortaba temprano con `if (!raw.sufijos) return null`, lo que
  // mandaba esas filas directo a "sin_identificar" en vez de aplicar ese
  // fallback -- por eso la mayoria de las lineas terminaban sin clasificar.
